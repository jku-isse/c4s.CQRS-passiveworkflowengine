Blockly.Blocks['artifact'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown([["Jira","jira_core_artifact"],["JiraDronology", "root/types/dronology_schema_Artifact"], ["Jama","jama_item"], ["Azure","azure_workitem"], ["GitHub Issue","git_issue"], ["Process Definition","ProcessDefinition"], ["ACME-RA Issue", "acme_issue"], ["ACME-RA Engineer", "acme_engineer"]]), "Type");
