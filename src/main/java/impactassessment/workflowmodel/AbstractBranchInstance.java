...
//	private Long id; //just used for neo4j OGM
	...
	/* (non-Javadoc)
	 * @see c4s.impactassessment.workflowmodel.IBranchInstance#getTask()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see c4s.impactassessment.workflowmodel.IBranchInstance#setTask(c4s.impactassessment.workflowmodel.WorkflowTask)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see c4s.impactassessment.workflowmodel.IBranchInstance#getBranchDefinition()
	 */
	@Override
...
//	}
	...
	/* (non-Javadoc)
	 * @see c4s.impactassessment.workflowmodel.IBranchInstance#getState()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see c4s.impactassessment.workflowmodel.IBranchInstance#setConditionsFulfilled()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see c4s.impactassessment.workflowmodel.IBranchInstance#setBranchUsedForProgress()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see c4s.impactassessment.workflowmodel.IBranchInstance#setConditionsNoLongerHold()
	 */
	@Override
