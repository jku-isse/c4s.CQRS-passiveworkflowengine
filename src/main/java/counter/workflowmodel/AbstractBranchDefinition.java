...
public abstract class AbstractBranchDefinition implements IBranchDefinition {
	...
	/* (non-Javadoc)
	 * @see c4s.impactassessment.workflowmodel.IBranchDefinition#getName()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see c4s.impactassessment.workflowmodel.IBranchDefinition#getTask()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see c4s.impactassessment.workflowmodel.IBranchDefinition#hasActivationCondition()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see c4s.impactassessment.workflowmodel.IBranchDefinition#hasDataFlow()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see c4s.impactassessment.workflowmodel.IBranchDefinition#createInstance()
	 */
	@Override
