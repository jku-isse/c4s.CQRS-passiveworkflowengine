...
//		
		wfp.on(new CreatedWorkflowEvt(workflowId, Map.of(new ArtifactIdentifier("UAV-1292", "IJiraArtifact"), "ROLE_WPTICKET"), "DRONOLOGY_WORKFLOW_FIXED", registry.get("DRONOLOGY_WORKFLOW_FIXED").getWfd()), status);
